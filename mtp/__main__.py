...
class MTPGadget(mtp.Gadget):
    ...
    def __enter__(self):
        ...
        self.gadget.strings['0x409'].manufacturer = 'Foo Inc.'
        self.gadget.strings['0x409'].product = 'Whizzotron'
        ...
        os.makedirs('/tmp/mtp', exist_ok=True)
...
def main():
    ...
    parser.add_argument('-n', '--name', type=str, help='MTP device name', default='Whizzle')
