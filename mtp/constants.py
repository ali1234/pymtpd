...
from construct import Enum, Int16ul

VERSION = 100

# MTP Container Types
container_type = Enum(Int16ul,
    UNDEFINED =   0,
    COMMAND =     1,
    DATA =        2,
    RESPONSE =    3,
...
object_property_code = Enum(Int16ul,
    STORAGE_ID =                            0xDC01,
...
device_property_code = Enum(Int16ul,
    UNDEFINED =                      0x5000,
    ...
    VOLUME =                         0xD403,
    SUPPORTED_FORMATS_ORDERED =      0xD404,
    DEVICE_ICON =                    0xD405,
...
# Storage File System
storage_file_system = Enum(Int16ul,
    FLAT =                0x0001,
    HIERARCHICAL =        0x0002,
    DCF =                 0x0003,
)
